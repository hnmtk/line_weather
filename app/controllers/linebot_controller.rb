      ...
      when Line::Bot::Event::Message
        ...
        when Line::Bot::Event::MessageType::Text
          ...
          when /.*(北海道|青森|岩手|宮城|秋田|山形|福島|茨城|栃木|群馬|埼玉|千葉|東京|神奈川|新潟|富山|石川|福井|山梨|長野|岐阜|静岡|愛知|三重|滋賀|京都|大阪|兵庫|奈良|和歌山|鳥取|島根|岡山|広島|山口|徳島|香川|愛媛|高知|福岡|佐賀|長崎|熊本|大分|宮崎|鹿児島|沖縄).*/
            prefecture = [{name:"北海道の天気", num:"01"}, {name:"青森の天気", num:"02"}, {name:"岩手の天気", num:"03"}, {name:"宮城の天気", num:"04"}, {name:"秋田の天気", num:"05"}, {name:"山形の天気", num:"06"},
                          {name:"福島の天気", num:"07"}, {name:"茨城の天気", num:"08"}, {name:"栃木の天気", num:"09"}, {name:"群馬の天気", num:"10"}, {name:"埼玉の天気", num:"11"}, {name:"千葉の天気", num:"12"},
                          {name:"東京の天気", num:"13"}, {name:"神奈川の天気", num:"14"}, {name:"新潟の天気", num:"15"}, {name:"富山の天気", num:"16"}, {name:"石川の天気", num:"17"}, {name:"福井の天気", num:"18"},
                          {name:"山梨の天気", num:"19"}, {name:"長野の天気", num:"20"}, {name:"岐阜の天気", num:"21"}, {name:"静岡の天気", num:"22"}, {name:"愛知の天気", num:"23"}, {name:"三重の天気", num:"24"},
                          {name:"滋賀の天気", num:"25"}, {name:"京都の天気", num:"26"}, {name:"大阪の天気", num:"27"}, {name:"兵庫の天気", num:"28"}, {name:"奈良の天気", num:"29"}, {name:"和歌山の天気", num:"30"},
                          {name:"鳥取の天気", num:"31"}, {name:"島根の天気", num:"32"}, {name:"岡山の天気", num:"33"}, {name:"広島の天気", num:"34"}, {name:"山口の天気", num:"35"}, {name:"徳島の天気", num:"36"},
                          {name:"香川の天気", num:"37"}, {name:"愛媛の天気", num:"38"}, {name:"高知の天気", num:"39"}, {name:"福岡の天気", num:"40"}, {name:"佐賀の天気", num:"41"}, {name:"長崎の天気", num:"42"},
                          {name:"熊本の天気", num:"43"}, {name:"大分の天気", num:"44"}, {name:"宮崎の天気", num:"45"}, {name:"鹿児島の天気", num:"46"}, {name:"沖縄の天気", num:"47"}]
